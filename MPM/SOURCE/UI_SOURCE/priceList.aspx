<%@ Page Title="" Language="C#" MasterPageFile="~/MasterMPM.master" AutoEventWireup="true" CodeFile="priceList.aspx.cs" Inherits="priceList" %>
      ...
      <form id="form5">
          ...
          <div class="container">
                 ...
                 <table id="customers">
                  ...
                  <tr>
                    <td>01</td>
                    <td><a href="Statistics.aspx">Potato</a></td>
                    
                  </tr>
                  <tr>
                    <td>02</td>
                    <td><a href="Statistics.aspx">Carot</a></td>
