<%@ Page Title="" Language="C#" MasterPageFile="~/MasterMPM.master" AutoEventWireup="true" CodeFile="price_Monitoring.aspx.cs" Inherits="price_Monitoring" %>
      ...
      <form id="form7">
          ...
          <div class="container">
                 ...
                 <table id="customers">
                  ...
                  <tr>
                    <td>01</td>
                    <td><a href="updated_price.aspx">Potato</a></td>
                  </tr>
                  <tr>
                    <td>02</td>
                    <td>Meat</td>
