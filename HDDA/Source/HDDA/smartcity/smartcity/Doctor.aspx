<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Doctor.aspx.cs" Inherits="smartcity.Doctor" %>
            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="Label3" runat="server" BorderColor="#CC3300" Text="Doctor Name:"></asp:Label>
                    </td>
                ...
                <tr>
                    <td class="auto-style4">Doctor Specialist at</td>
                ...
                <tr>
                    <td class="auto-style7">Time To service</td>
                    <td class="auto-style8">
