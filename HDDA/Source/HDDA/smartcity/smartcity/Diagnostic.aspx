<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Diagnostic.aspx.cs" Inherits="smartcity.Diagnostic" %>
            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style5">
                        <asp:Label ID="Label3" runat="server" BorderColor="#CC3300" Text="Your Diagnostic center Name:"></asp:Label>
                    </td>
                ...
                <tr>
                    <td class="auto-style7">Open and Close Time</td>
                    <td class="auto-style8">
                        <asp:TextBox ID="TextBox7" runat="server" Width="366px" Height="34px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style7">Contact Phone Number</td>
                    <td class="auto-style8">
                ...
                <tr>
                    ...
                    <td class="auto-style8">
                        <asp:CheckBox ID="CheckBox1" Text="X-Ray" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style7"></td>
                    <td class="auto-style8">
                        <asp:CheckBox ID="CheckBox2" Text="ECG" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style7">&nbsp;</td>
                    <td class="auto-style8">
                        <asp:CheckBox ID="CheckBox3" Text="Blood Test" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style7">&nbsp;</td>
                    <td class="auto-style8">
                        <asp:CheckBox ID="CheckBox4" Text="Other" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style7"></td>
