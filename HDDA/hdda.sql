...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2018 at 08:16 PM
...
--
-- Table structure for table `hdda_admin_ambulance`
--

CREATE TABLE `hdda_admin_ambulance` (
  `hid` int(11) NOT NULL,
  `aid` int(11) NOT NULL
...
--
-- Table structure for table `hdda_admin_diagonestic`
--

CREATE TABLE `hdda_admin_diagonestic` (
  `did` int(11) NOT NULL,
  `hid` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `hdda_admin_doctor`
--

CREATE TABLE `hdda_admin_doctor` (
  `diagoid` int(11) NOT NULL,
  `hid` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `hdda_admin_donor`
--

CREATE TABLE `hdda_admin_donor` (
  `hid` int(11) NOT NULL,
...
--
-- Indexes for table `hdda_admin_ambulance`
--
ALTER TABLE `hdda_admin_ambulance`
  ADD KEY `hid` (`hid`),
  ADD KEY `aid` (`aid`);

--
-- Indexes for table `hdda_admin_diagonestic`
--
ALTER TABLE `hdda_admin_diagonestic`
  ADD KEY `did` (`did`),
  ADD KEY `hid` (`hid`);

--
-- Indexes for table `hdda_admin_doctor`
--
ALTER TABLE `hdda_admin_doctor`
  ADD KEY `diagoid` (`diagoid`);

--
-- Indexes for table `hdda_admin_donor`
--
ALTER TABLE `hdda_admin_donor`
  ADD KEY `hid` (`hid`),
